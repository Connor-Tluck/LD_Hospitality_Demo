...
/**
 * Dedicated `/welcome` route so `router.replace("/welcome")` from inside `(tabs)` is unambiguous.
 * `router.replace("/")` becomes REPLACE `index`, which collides with `(tabs)/index` and is not handled.
 */
